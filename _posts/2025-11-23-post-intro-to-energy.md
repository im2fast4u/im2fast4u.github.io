...
A real life example of using energy is when you run around, or when you jump up or down. Your energy is making you do these things by force. Albert Einstein defined a form of energy called rest energy as mass times the speed of light squared ($E = mc^2$). This means that the heavier you are, the more energy you have. This formula shows that mass can be converted to energy. There are many different forms of energy such as heat energy, kinetic energy, chemical energy, electrical energy, etc.
