...
## A Simple Function
In the last section I told you about linear equations. They come in the form $y = mx + b$, or $f(x) = mx + b$. The '$m$' variable represents the slope[^1] of the equation, and the '$b$' variable represents the y-coordinate of the y-intercept[^2] of the equation. The function I am going to use is $y = 3x - 4$. Whatever number/input we give the function, we get an output. Suppose our input is 3. If the variable $x$ represents the input, and the variable $y$ represents the output, our output would be 3(3) - 4, and acording to PEMDAS, that is 5. 
