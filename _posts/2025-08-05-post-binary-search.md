...
For example, let's say I tell you to guess a number between 1 and a 100, and you have to guess that number in the fewest tries possible. I will tell you if your number is too high, too low or correct. So, let's say you guess 1, then you guess 2, and so on. That is simple search. It will take you 100 tries to get the answer correct in the worst case. But in binary search, you always guess the number in between the choices.
